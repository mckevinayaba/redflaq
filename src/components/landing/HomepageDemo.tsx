        ...
        <div style={{ display: "flex", gap: 60, alignItems: "flex-start", flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 340px", minWidth: 280, paddingTop: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                { icon: <FileText size={16} />, label: "Public records only" },
                { icon: <Shield size={16} />, label: "POPIA aware" },
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20, marginTop: 32 }}>
        {[
          ...
          <div key={i} style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <ScanDot delay={i * 400} />
            <span style={{
              fontFamily: "'Inter', sans-serif", fontSize: 14, color: "#1F1F1F",
            }}>{line}</span>
          </div>
        ))}
      </div>
      <p style={{
        fontFamily: "'Inter', sans-serif", fontSize: 12, color: "#999",
  ...
  return (
    <div>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
        ...
        <span style={{
          background: "#FFF3E0", color: "#E65100", fontFamily: "'Inter', sans-serif",
          fontSize: 13, fontWeight: 700, padding: "6px 16px", borderRadius: 50,
        }}>Moderate Risk</span>
      </div>
      <p style={{
      ...
      <p style={{
        fontFamily: "'Inter', sans-serif", fontSize: 14, color: "#666666",
      ...
      <div style={{
        ...
        border: "1px solid #E6E0DA", borderRadius: 12, overflow: "hidden",
      }}>
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 24 }}>
        <ActionButton icon={<Download size={16} />} label="Download PDF Report" variant="outline" />
        <ActionButton icon={<User size={16} />} label="Save to Free Safety Account" variant="outline" />
      </div>
      <div style={{
...
function JournalPanel() {
  return (
    <div>
      ...
      <div style={{
        background: "#FAFAF8", border: "1px solid #E6E0DA", borderRadius: 12,
...
function FormField({ label, value }: { label: string; value: string }) {
  return (
    <div>
      ...
      <div style={{
        background: "#FAFAF8", border: "1px solid #E6E0DA", borderRadius: 10,
        padding: "12px 16px", fontFamily: "'Inter', sans-serif", fontSize: 14,
        color: "#1F1F1F",
      }}>{value}</div>
    </div>
  );
...
function InfoRow({ label, value, last }: { label: string; value: string; last?: boolean }) {
  return (
    <div style={{
      ...
      <span style={{ fontFamily: "'Inter', sans-serif", fontSize: 13, color: "#666666" }}>{label}</span>
      <span style={{ fontFamily: "'Inter', sans-serif", fontSize: 13, fontWeight: 600, color: "#1F1F1F" }}>{value}</span>
    </div>
  );
}

function ActionButton({ icon, label, variant }: { icon: React.ReactNode; label: string; variant: "outline" }) {
  return (
    <button style={{
