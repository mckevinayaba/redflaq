      ...
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8" style={{ marginBottom: 48 }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{ position: 'relative', width: 160, height: 160, margin: '0 auto 20px', borderRadius: '45% 55% 50% 50% / 50% 45% 55% 50%', overflow: 'hidden', boxShadow: '0 8px 32px rgba(107,78,255,0.2)' }}>
            ...
            <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, letterSpacing: '0.06em', color: '#6B4EFF', marginBottom: 8, lineHeight: 1.5 }}>
              Survivor, GBV Advocate & TV Host · Co‑Founder & CEO, RedFlaq
            </div>
            <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 12, color: '#6B4EFF', marginBottom: 16, fontStyle: 'italic', lineHeight: 1.5 }}>
              Author of <em>"Women Arise with Power"</em>, her life story as a GBV survivor.
            </div>
            <p style={{ fontFamily: "'Syne', sans-serif", fontSize: 13, color: '#555555', lineHeight: 1.7, marginBottom: 12, textAlign: 'left' }}>
            ...
            <blockquote style={{ fontFamily: "'DM Serif Display', serif", fontSize: 14, fontStyle: 'italic', color: '#6B4EFF', lineHeight: 1.6, borderLeft: '3px solid #6B4EFF', paddingLeft: 16, textAlign: 'left' }}>
          ...
          {/* Ayola */}
          <div style={{ textAlign: 'center' }}>
            <div style={{ position: 'relative', width: 160, height: 160, margin: '0 auto 20px', borderRadius: '50% 45% 55% 50% / 45% 55% 50% 50%', overflow: 'hidden', boxShadow: '0 8px 32px rgba(107,78,255,0.2)' }}>
              <img src={ayolaPhoto} alt="Ayola Masizana, Brand Ambassador of RedFlaq" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </div>
            <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 18, fontWeight: 800, color: '#1F1F1F', marginBottom: 4 }}>
              Ayola Masizana
            </div>
            <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, letterSpacing: '0.06em', color: '#6B4EFF', marginBottom: 16, lineHeight: 1.5 }}>
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{ position: 'relative', width: 160, height: 160, margin: '0 auto 20px', borderRadius: '55% 45% 50% 50% / 50% 50% 50% 50%', overflow: 'hidden', boxShadow: '0 8px 32px rgba(107,78,255,0.2)' }}>
              <img src={mckevinPhoto} alt="McKevin Ayaba, Co-Founder & CPO of RedFlaq" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </div>
            <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 18, fontWeight: 800, color: '#1F1F1F', marginBottom: 4 }}>
              McKevin Ayaba
            </div>
            <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, letterSpacing: '0.06em', color: '#6B4EFF', marginBottom: 4, lineHeight: 1.5 }}>
          ...
          {cards.map(card => (
            ...
            >
              <div style={{
                ...
                <card.Icon style={{ width: 24, height: 24, color: '#6B4EFF' }} />
              </div>
