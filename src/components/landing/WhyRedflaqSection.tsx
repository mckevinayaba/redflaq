  ...
  return (
    <section id="about" ref={ref} className={`scroll-reveal ${isVisible ? 'visible' : ''}`} style={{ background: '#F7F4F0', padding: '60px 40px 80px' }}>
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        {/* Founder quote */}
        <div style={{ maxWidth: 700, margin: '32px auto', borderLeft: '4px solid #7C3AED', paddingLeft: 24 }}>
        ...
        <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: 24, fontStyle: 'italic', color: '#7C3AED', textAlign: 'center', marginTop: 32 }}>
          Because information creates safety. And safety should never be a privilege.
        </p>

        {/* Principle cards */}
        <div className="flex flex-col md:flex-row gap-4" style={{ marginTop: 32 }}>
          {cards.map(card => (
