    ...
    <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: 10 }}>
      ...
      <button
        ...
        style={{
          ...
          color: liked ? '#7C3AED' : '#555555',
          background: liked ? 'rgba(124,58,237,0.08)' : 'rgba(0,0,0,0.04)',
          border: liked ? '1px solid rgba(124,58,237,0.2)' : '1px solid rgba(0,0,0,0.08)',
      ...
      <button
        ...
        style={{
          ...sans, fontSize: 13, fontWeight: 600,
          color: saved ? '#7C3AED' : '#555555',
          background: saved ? 'rgba(124,58,237,0.08)' : 'rgba(0,0,0,0.04)',
          border: saved ? '1px solid rgba(124,58,237,0.2)' : '1px solid rgba(0,0,0,0.08)',
          padding: '8px 16px', borderRadius: 50, cursor: 'pointer',
          display: 'flex', alignItems: 'center', gap: 6, transition: 'all 0.2s',
        }}
      ...
      <a
        ...
        style={{
          ...sans, fontSize: 13, fontWeight: 600, color: '#25D366',
          background: 'rgba(37,211,102,0.06)', border: '1px solid rgba(37,211,102,0.15)',
          padding: '8px 16px', borderRadius: 50, cursor: 'pointer',
          display: 'flex', alignItems: 'center', gap: 6, textDecoration: 'none', transition: 'all 0.2s',
        }}
      >
      ...
      <a
        ...
        rel="noopener noreferrer"
        style={{
          ...sans, fontSize: 13, fontWeight: 600, color: '#555555',
          background: 'rgba(0,0,0,0.04)', border: '1px solid rgba(0,0,0,0.08)',
          padding: '8px 14px', borderRadius: 50, cursor: 'pointer',
          display: 'flex', alignItems: 'center', gap: 6, textDecoration: 'none', transition: 'all 0.2s',
        }}
      >
        <svg width="11" height="11" viewBox="0 0 24 24" fill="#555555"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
        Post
      </a>
      ...
      <button
        ...
        style={{
          ...sans, fontSize: 13, fontWeight: 600, color: '#555555',
          background: 'rgba(0,0,0,0.04)', border: '1px solid rgba(0,0,0,0.08)',
          padding: '8px 14px', borderRadius: 50, cursor: 'pointer', transition: 'all 0.2s',
        }}
        title="Copy link"
      >
        🔗
