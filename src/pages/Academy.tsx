  ...
  return (
    <div style={{ background: "#F5F0EB", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "100px 24px 60px" }}>
        ...
        <p style={{ fontFamily: "'Syne', sans-serif", fontSize: 16, color: "#78716C", lineHeight: 1.6, maxWidth: 600, marginBottom: 32 }}>
          Articles, guides, and resources to help South African women and communities stay safe. Free knowledge, built for impact.
        </p>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: "center", padding: 60, background: "white", border: "1.5px solid #D6D3CD" }}>
            ...
            <p style={{ fontFamily: "'Syne', sans-serif", fontSize: 14, color: "#78716C" }}>
              ...
              <Link to="/tools" style={{ color: "#7C3AED", fontWeight: 700 }}>explore our free safety tools</Link>.
            </p>
          </div>
        ) : (
