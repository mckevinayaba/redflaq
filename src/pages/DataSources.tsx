...
const DATA_SOURCES: DataSource[] = [
  ...
  {
    name: "South African Court Records — Criminal Judgments",
    shortName: "SA Court Records",
    url: "https://www.justice.gov.za",
    description: "Criminal court judgments from South African High Courts, Supreme Court of Appeal, and Constitutional Court.",
    ...
    trustLabel: "Source: South African Court Records",
  },
  {
  ...
  {
    name: "International Compliance Databases — PEPs, Sanctions & Watchlists",
    shortName: "Compliance Databases",
    url: "https://www.fica.gov.za",
    description: "Real-time queries across international sanctions lists, politically exposed persons (PEPs), watchlists, and corruption-linked entities. Results are live — not cached snapshots.",
    dataTypes: ["PEPs", "Sanctions lists", "Wanted persons", "Corruption links", "FIC sanctions", "International watchlists"],
    legalBasis: "Aggregated from publicly available government sanctions lists and law enforcement databases worldwide.",
    updateFrequency: "Real-time (live query per search)",
    status: "active", statusLabel: "Live",
    icon: <Database className="h-5 w-5" />,
    trustLabel: "Source: Verified Compliance Database",
  },
];
