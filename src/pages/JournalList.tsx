...
import { Plus, FileDown, Search, Trash2, Eye, FileText, Scale } from "lucide-react";
...
export default function JournalList() {
  ...
  return (
    <DashboardLayout>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          ...
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 rounded-lg border border-border bg-card text-foreground font-body text-sm"
            />
          </div>
        </div>
      )}
      ...
      {filteredEntries.length === 0 ? (
        ...
        <div className="space-y-4">
          {filteredEntries.map(entry => {
            ...
            return (
              <div key={entry.id} className="bg-card rounded-xl border border-border p-5 hover:shadow-md transition-shadow">
      ...
      {/* Legal Disclaimer */}
      <div className="mt-8 bg-muted/50 rounded-xl border border-border p-5">
