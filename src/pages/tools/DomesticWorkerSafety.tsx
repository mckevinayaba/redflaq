    ...
    >
      ...
      {progress === 100 && (
        <div style={{ background: "#F0FDF4", border: "2px solid #22C55E", padding: 24, textAlign: "center", marginTop: 24 }}>
          ...
          <h3 style={{ fontFamily: "'DM Serif Display', serif", fontSize: 22, color: "#2D2235", margin: "8px 0" }}>Checklist complete!</h3>
          <p style={{ fontFamily: "'Syne', sans-serif", fontSize: 14, color: "#78716C" }}>You've done the right thing by checking thoroughly. Your family's safety matters.</p>
        </div>
      )}
    </ToolLayout>
  );
