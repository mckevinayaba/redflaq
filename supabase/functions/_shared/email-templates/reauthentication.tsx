...
const codeStyle = { fontFamily: "'JetBrains Mono', Courier, monospace", fontSize: '32px', fontWeight: 'bold' as const, color: '#7C3AED', margin: '0 0 30px', textAlign: 'center' as const, letterSpacing: '6px' }
