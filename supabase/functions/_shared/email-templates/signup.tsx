...
const ctaButton = { display: 'inline-block' as const, backgroundColor: '#7C3AED', color: '#ffffff', fontSize: '16px', fontWeight: '600' as const, textDecoration: 'none', padding: '16px 40px', borderRadius: '50px', letterSpacing: '0.3px' }
const mutedCenter = { margin: '0 0 32px', fontSize: '13px', color: '#999999', textAlign: 'center' as const }
const divider = { border: 'none', borderTop: '1px solid #eeeeee', margin: '0 0 28px' }
const sectionLabel = { margin: '0 0 14px', fontSize: '14px', fontWeight: '700' as const, color: '#1a0a2e', textTransform: 'uppercase' as const, letterSpacing: '0.5px' }
const benefitsBox = { backgroundColor: '#f3f0ff', borderRadius: '12px', padding: '20px 24px' }
const benefitItem = { padding: '6px 0', fontSize: '15px', color: '#333333', margin: '0' }
