...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Welcome to RedFlaq — one click to activate your account',
  invite: "You've been invited to join RedFlaq",
  magiclink: 'Your RedFlaq login link',
  recovery: 'Reset your RedFlaq password',
  email_change: 'Confirm your email change — RedFlaq',
  reauthentication: 'Your RedFlaq verification code',
}
...
// Configuration
const SITE_NAME = "redflaq"
const SENDER_DOMAIN = "notify.redflaq.com"
const ROOT_DOMAIN = "redflaq.com"
const FROM_DOMAIN = "redflaq.com" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://redflaq.lovable.app"
